...
// import {getServerSideProps as getServerSidePropsVols} from "src/lib/redux/app/services/eod_implied_vols";
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-blueGray-600">
                Notus NextJS - A beautiful extension for Tailwind CSS for Adja.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                Notus NextJS is Free and Open Source. It does not change any of
                the CSS from{" "}
                <a
                  href="https://"//https://tailwindcss.com/?ref=creativetim
